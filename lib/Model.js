...
class Model {
    ...
    getColumnDefinition(fieldName, fieldOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fieldType instanceof Schema_1.FrozenType) {
                ...
                if (!type)
                    throw new Error(`Model "${this.name}" requires the "${fieldName}" user defined type which was not found!`);
                yield type.load();
    ...
    load(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.schema.definition.created_at == undefined ||
                this.schema.definition.created_at == null)
                columns.push(yield this.getColumnDefinition("created_at", {
                    cluseringKey: true,
                    type: "timestamp",
                }));
            columns.push(yield this.getColumnDefinition("edited_at", {
                partitionKey: false,
                type: "timestamp",
            }));
            if (this.schema.definition.id == undefined ||
                this.schema.definition.id == null)
                columns.push(yield this.getColumnDefinition("id", {
                    partitionKey: true,
                    type: "uuid",
                }));
